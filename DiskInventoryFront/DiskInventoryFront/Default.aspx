...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">This application is used to view information about the disks and manage the borrowing of the inventory.</p>
        <br />
        
        <div class ="container">
            <h6>Here is a list of all available disks!</h6>
