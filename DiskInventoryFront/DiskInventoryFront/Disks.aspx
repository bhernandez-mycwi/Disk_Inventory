...
<p class="text-center">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:disk_inventoryBHConnectionString2 %>" 
        ...
        SelectCommand="SELECT disk_id, disk_name, disk_status, disk_type, genre_id, release_date FROM disk_info" 
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="diskStatus" Type="Int32" />
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="disk_id" DataSourceID="SqlDataSource1" InsertItemPosition="LastItem" style="margin-right: 0px">
        ...
        <EditItemTemplate>
            ...
            <tr style="">
                <td>
                    <asp:Button ID="UpdateButton" runat="server" CommandName="Update" Text="Update" CausesValidation="True" />
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Disk Name is required" CssClass="text-danger" Display="Dynamic" ControlToValidate="disk_nameTextBox"></asp:RequiredFieldValidator>
                </td>
                <td>
                  <%-- Status requires validation for data type, cannot accept nulls, and must be either 1 or 2 --%>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Disk Status is required" ControlToValidate="disk_statusTextBox" Display="Dynamic" CssClass="text-danger"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator4" runat="server" ErrorMessage="Status must be either a 1 or 2" ControlToValidate="disk_statusTextBox" CssClass="text-danger" Display="Dynamic" MaximumValue="2" MinimumValue="1" Type="Integer"></asp:RangeValidator>
                    <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="disk_statusTextBox" Display="Dynamic" CssClass="text-danger" ErrorMessage="Status must be a whole number" Type="Integer" Operator="DataTypeCheck"></asp:CompareValidator>
                ...
                <td>
                   <%-- Disk Type requires validation for data type, cannot accept nulls, and must be either 1 or 2 --%>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="text-danger" Display="Dynamic" ErrorMessage="Disk Type is required" ControlToValidate="disk_typeTextBox"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator5" runat="server" ErrorMessage="Type must be either a 1 or 2" ControlToValidate="disk_typeTextBox" CssClass="text-danger" Display="Dynamic" MaximumValue="2" MinimumValue="1" Type="Integer"></asp:RangeValidator>
                    <asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="disk_typeTextBox" Display="Dynamic" CssClass="text-danger" ErrorMessage="Type must be a whole number" Type="Integer" Operator="DataTypeCheck"></asp:CompareValidator>
                </td>
                <td>
                   <%-- Genre requires validation for data type, cannot accept nulls, and must a value between 1 and 4 --%>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Genre is required" CssClass="text-danger" Display="Dynamic" ControlToValidate="genre_idTextBox"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator6" runat="server" ErrorMessage="Genre must be between 1 and 4" ControlToValidate="genre_idTextBox" CssClass="text-danger" Display="Dynamic" MaximumValue="4" MinimumValue="1" Type="Integer"></asp:RangeValidator>
                    <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToValidate="genre_idTextBox" Display="Dynamic" CssClass="text-danger" ErrorMessage="Genre must be a whole number" Type="Integer" Operator="DataTypeCheck"></asp:CompareValidator>
                </td>
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" CssClass="text-danger" Display="Dynamic" ErrorMessage="Release Date is required" ControlToValidate="release_dateTextBox"></asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="CompareValidator2" runat="server" ErrorMessage="Incorrect Date format" ControlToValidate="release_dateTextBox" Display="Dynamic" CssClass="text-danger" Operator="DataTypeCheck" Type="Date"></asp:CompareValidator>
                </td>
            </tr>
        </EditItemTemplate>
        <EmptyDataTemplate>
        ...
        <ItemTemplate>
            <tr style="">
                <td>
                    ...
                    <asp:Button ID="EditButton0" runat="server" CommandName="Edit" Text="Edit" CausesValidation="False" />
                </td>
                <td>
